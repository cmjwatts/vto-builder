...
window.VTO_SECTIONS = [
  ...
  },
  {
    ...
    duration: "10–15 min",
    definition: "Your targets for the quarter ahead — date, revenue, profit, and measurables — plus the 3–7 Company Rocks that get you there, each owned by one person.",
    why: "The 90-Day Plan is how 1-Year goals actually get done — broken into a single quarter with clear numbers and a short list of priorities. Discipline at the quarter level is what builds traction over the year.",
    example: 'Rock: "Launch new client onboarding process." Owner: "Priya."',
    fields: [
      { type: "text", key: "targetDate", label: "Future date", placeholder: "e.g. March 31, 2026" },
      { type: "text", key: "revenue",    label: "Revenue",     placeholder: "e.g. $2.4M" },
      { type: "text", key: "profit",     label: "Profit",      placeholder: "e.g. $300K (12%)" },
      { type: "list", key: "measurables", label: "Measurables (up to 3 KPIs)", min: 1, max: 3,
        addLabel: "Add a measurable",
        placeholders: { name: "e.g. 350 active client accounts" } },
      { type: "list", key: "items", label: "Company Rocks (3–7)", min: 3, max: 7,
